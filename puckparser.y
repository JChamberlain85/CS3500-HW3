...
WhileStatement
    : K_WHILE Expression K_DO StatementSequence K_END
...
WriteStatement
    : K_WRITE K_LPAREN Expression K_RPAREN
      { cout << "RULE: WriteStatement ::= WRITE (Expression)" << endl; }
    ;

Assignment
    : T_IDENT OP_ASSIGN Expression
...
int main()
{
    ...
    // Output required by the assignment specs
    if (failcode)
        cout << "INVALID!" << endl;
    else
        cout << "VALID" << endl;
